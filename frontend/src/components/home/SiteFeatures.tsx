...
export default function SiteFeatures() {
  const items: FeatureItem[] = [
    {
      img: {
        src: "/img/bulb_think.svg",
        alt: "Bulb Think",
        className: "flex flex-center text-gray-500 h-[40px] w-[40px] m-[5px]",
      },
    ...
    {
      img: {
        src: "/img/bulb_play.svg",
        alt: "Bulb Play",
        className: "flex flex-center text-gray-500 h-[50px] w-[60px]",
      },
    ...
    {
      img: {
        src: "/img/bulb_idea.svg",
        alt: "Bulb Idea",
        className: "flex flex-center text-gray-500 h-[50px] w-[50px]",
      },
      ...
      <div className="flex flex-col justify-stretch justify-items-stretch gap-6 p-4 md:p-16 text-balance text-center sm:flex-row">
        {items.map((item, index) => (
          <div key={index} className="flex-1 flex flex-col items-center p-4">
            <Image {...item.img} width={50} height={50} loading="eager" />
